  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="ml-64 flex-1 bg-white">
        ...
        {/* Page Content with 64px side spacing */}
        <div className="px-16 py-6">
          <h1 className="text-3xl font-bold mb-6">Dashboard</h1>
          <p className="text-gray-600 mb-6">Welcome back, Teacher name</p>

          <h2 className="text-2xl font-bold mt-8 mb-2">Recent Exams</h2>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-2">Recent Cheating Incidents</h2>
          <table className="w-full text-left border">
            <thead>
              <tr className="bg-[#002855] text-white">
